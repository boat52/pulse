...
// source: pulse/pulse/v1/tx.proto
...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_be91b529d54d9eb1, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_be91b529d54d9eb1, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "pulse.pulse.v1.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "pulse.pulse.v1.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("pulse/pulse/v1/tx.proto", fileDescriptor_be91b529d54d9eb1) }

var fileDescriptor_be91b529d54d9eb1 = []byte{
	// 319 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x2f, 0x28, 0xcd, 0x29,
	0x4e, 0xd5, 0x87, 0x90, 0x65, 0x86, 0xfa, 0x25, 0x15, 0x7a, 0x05, 0x45, 0xf9, 0x25, 0xf9, 0x42,
	...
	0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xa8, 0x72, 0x12, 0x79, 0x16, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pulse.pulse.v1.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pulse.pulse.v1.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "pulse.pulse.v1.Msg",
	...
	Metadata: "pulse/pulse/v1/tx.proto",
}
